      ...
      <header className="sticky top-0 z-50 bg-white dark:bg-gray-800 shadow-md bg-opacity-95 backdrop-blur-lg">
        <nav className="flex justify-between items-center px-1 lg:px-5 py-4">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link to="/become-a-mentor" className="text-gray-800 dark:text-white hover:text-orange-500 transition-all">
              Become a Mentor
            </Link>
            ...
            <div className="relative" ref={accountMenuRef}>
              ...
              >
                {loading ? <span>Loading...</span> : user ? (
                  <>
                    <img src={user.profile || "/assets/images/default-avatar.png"} alt="Profile" className="w-6 h-6 rounded-full" />
                    <span>{user.name}</span>
                  </>
                ) : (
                  <span>Account</span>
